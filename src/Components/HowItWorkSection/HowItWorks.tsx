...
// import React, { JSX, useState, useEffect, useRef } from "react";
// import { motion } from "framer-motion";
// import SwipeCards from "../Components/HowItWorkSection/SwipeCards";
...
//     description:
//       "Get the financial boost you need to bring your boldest and most innovative ideas to life. We've got your back with support for production costs and gear upgrades—no strings attached.",
//     bgColor: "bg-[#FFBDA8]",
//   },
//   {
//     icon: "/frame-10.svg",
...
//   },
// ];
// // Stacked cards component for returning users
// const StackedCards = ({
//   activeCard,
//   setActiveCard,
//   isNewUser,
...
//               <div className="flex items-start justify-start gap-4 mb-5">
//                 <div className="w-12 h-12 flex items-center justify-center bg-white rounded-lg shadow-sm">
//                   <Image className="w-6 h-6" alt={card.title} src={card.icon} width={24} height={24} />
//                 </div>
//                 <h3 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent pt-1">
//                   {card.title}
//                 </h3>
