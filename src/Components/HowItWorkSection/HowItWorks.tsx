        ...
        <div className="flex flex-col md:flex-row items-start justify-between">
          ...
          >
            <div className="mb-1 md:mb-1">
              ...
              <p className="mt-2 md:mt-3 text-gray-600 max-w-full text-lg">
            ...
            <div className="hidden md:flex mt-4 gap-2" role="tablist" aria-label="Card navigation">
...
const StackedCards = ({
  ...
  return (
    <div className="relative min-h-[250px] w-full overflow-visible" role="tabpanel" aria-label="Card stack display">
      {stepCards.map((card, index) => {
            ...
            <div className="flex flex-col">
              ...
              {position === 0 && (
                <motion.div
                  ...
                  className="mt-1 flex items-center text-sm text-gray-600 justify-center"
