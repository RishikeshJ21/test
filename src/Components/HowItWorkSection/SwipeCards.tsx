      ...
      <div className="p-6 md:p-8 flex flex-col justify-between h-full">
        <div>
          <div className="flex gap-4 mb-3">
            ...
            <h3 className={`${window.innerWidth > 379 ? "pt-2" : title === "Fund Your Vibes" || title === "Level Up Your Skills" ? "pt-2" : ""} text-[20px] md:text-3xl font-bold text-black`}>
              {title}
            </h3>
          </div>
...
//       aria-label={`${title} card - ${isFront ? 'Active' : 'Stacked'}`}
//     >
//       <div className="p-6 md:p-8 gap-4 flex flex-col">
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: 0.3, duration: 0.5 }}
//             className="bottom-6 text-center text-sm text-gray-600 flex items-center justify-center ml-[25%] mt-2"
//             aria-label="Swipe instruction"
//           >
//             <motion.svg
//               animate={{ y: [0, -5, 0] }}
