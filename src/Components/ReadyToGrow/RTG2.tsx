...
export const ReadyToGrow2 = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col w-full max-w-[94%] lg:max-w-[86%] items-center justify-center mx-auto py-1 sm:py-6 md:py-2 px-2 sm:px-6 lg:px-2">
      <motion.div
        id="ready-to-grow"
        className="relative w-full p-7 sm:p-10 md:p-16 lg:px-[70px] lg:py-[40px] bg-[#1a1d21] rounded-2xl min-h-auto hover:bg-gradient-to-br hover:from-[#1a1d21] hover:to-[#2a2d35] transition-all duration-700"
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between xl:gap-10 ">
          {/* Left content section */}
          <div className="flex flex-col w-full lg:w-[490px] 2xl:w-[580px] items-center lg:items-start gap-8 md:gap-[40px] 2xl:gap-[50px]">
            <div className="flex flex-col items-center lg:items-start gap-5 w-full text-center lg:text-left">
              <motion.h2
            ...
            >
              ...
              <Button
                ...
                className="relative px-10 sm:px-[40px] py-4 sm:py-[22px] bg-white rounded-xl hover:bg-white mb-0 transition-all duration-300 group-hover:text-[#6e2db8] overflow-hidden"
              >
          ...
          {/* Right image section - now visible on all screen sizes with responsive adjustments */}
          <div className="hidden lg:block relative w-full sm:w-[430px] md:w-[520px] h-[300px] sm:h-[350px] md:h-[400px] mt-12 md:mt-0">
...
//         <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-10 md:gap-[60px] lg:gap-[90px] 2xl:gap-[120px]">
//           {/* Left content section */}
//           <div className="flex flex-col w-full lg:w-[490px] 2xl:w-[580px] items-center lg:items-start gap-8 md:gap-[40px] 2xl:gap-[50px]">
//             <div className="flex flex-col items-center lg:items-start gap-5 w-full text-center lg:text-left">
//               <motion.h2
...
//           {/* Right image section - now visible on all screen sizes with responsive adjustments */}
//           <div className="hidden lg:block relative w-full sm:w-[430px] md:w-[450px] lg:w-[520px] h-[300px] sm:h-[350px] md:h-[400px] mt-8 lg:mt-0">
//             <div className="relative h-full w-full flex justify-center lg:justify-start">
//               <motion.div
//                 initial={{ opacity: 0, y: 30 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 transition={{ duration: 0.7, delay: 0.3 }}
...
//                 />
                //    <img
                //   className="mx-auto lg:mx-0 w-full max-w-[300px] sm:max-w-[340px] md:max-w-[380px] h-auto object-cover rounded-lg hover:shadow-[0_0_30px_rgba(138,43,226,0.4)] transition-shadow duration-300"
