...
//   return (
//     // Adjust the timeline here if needed
//     <motion.section className={`relative ${pathname === "/" ? "py-16" : "py-1"} px-4 md:px-6 overflow-hidden bg-gradient-to-b from-[rgba(255,255,255,0.57)] to-[#f8f5ff] min-h-[70vh] flex items-center`}
//       initial={{
//         // y:100
//         opacity: 0,
//       }}
